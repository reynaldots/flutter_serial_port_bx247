                      ...
                      Row(
                        children: <Widget>[
                          ...
                          RaisedButton(
                            ...
                            onPressed: store.device != null
                                ? () {
                              _serialPort.sendCommand(_commandController.text, _dataController.text);
                              setState(() {
                                _historyData.add(Text("<<< ${_commandController.text} -  ${_dataController.text}"));
                              });
                            }
                                : null,
                          ),
                          ...
                          RaisedButton(
                            ...
                            onPressed: store.device != null
                                ? () {
                              _serialPort.sendCommand('statusElevator', null);
                              setState(() {
                                _historyData.add(Text("<<< statusElevator"));
                              });
                            }
                                : null,
                          ),
